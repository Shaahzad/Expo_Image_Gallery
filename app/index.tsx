...
export default function ImageGallery() {
    ...
    useEffect(() => {
        const loadImage = async () => {
            ...
            if (savedImage) {
                ...
                setImage((prevImages) => [...prevImages, ...parsedImg]);  // Concatenate with existing images
    ...
    const uploadImageToCloudinary = async (imageuri: any): Promise<void> => {
        ...
        try {
            ...
            // Append the new image URL to the existing images
            setImage((prevImages) => [...prevImages, imageUrl]);
            console.log('Image URL:', imageUrl);

            // Retrieve existing images from AsyncStorage
            ...
            const updatedImages = [...parsedImages, imageUrl];
        ...
        <SafeAreaView style={{ flex: 1 }}>
            ...
            {loading ? (
                ...
                <FlatList
                    ...
                    renderItem={({ item }) => {
                        return (
                            <Image style={{ height: 230, marginVertical: 10 }} source={{ uri: item }} />
                        );
                    }}
                />
            )}
